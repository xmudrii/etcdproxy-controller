...
import (
	...
	samplecontroller "github.com/xmudrii/etcdproxy-controller/pkg/apis/etcd/v1alpha1"
	"github.com/xmudrii/etcdproxy-controller/pkg/client/clientset/versioned/fake"
...
type fixture struct {
	...
	fooLister        []*samplecontroller.EtcdStorage
...
func newFoo(name string, replicas *int32) *samplecontroller.EtcdStorage {
	return &samplecontroller.EtcdStorage{
		TypeMeta: metav1.TypeMeta{APIVersion: samplecontroller.SchemeGroupVersion.String()},
		ObjectMeta: metav1.ObjectMeta{
			Name:      name,
			Namespace: metav1.NamespaceDefault,
		},
		Spec: samplecontroller.EtdcStorageSpec{
...
func (f *fixture) newController() (*Controller, informers.SharedInformerFactory, kubeinformers.SharedInformerFactory) {
	...
	c := NewEtcdStorageController(f.kubeclient, f.client,
		k8sI.Apps().V1().Deployments(), i.Samplecontroller().V1alpha1().Foos())

	c.etcdstoragesSynced = alwaysReady
...
func (f *fixture) expectUpdateFooStatusAction(foo *samplecontroller.EtcdStorage) {
...
func getKey(foo *samplecontroller.EtcdStorage, t *testing.T) string {
